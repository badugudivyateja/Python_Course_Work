...
dict_d = {1: "Divya", 2: "Teja", 3: "Badugu"}
print(list(dict_d))  # [1, 2, 3]


# Dictionary conversion ('Divyateja')
d = [('name', 'Divyateja'), ('batch', '22'), ('subject', 'python')]
print(dict(d))  # {'name': 'Divyateja', 'batch': '22', 'subject': 'python'}